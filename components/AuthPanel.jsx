  ...
  return (
    <div className="panel stack">
      <div className="row space-between">
        ...
        <span className="badge status-pill">{syncing ? 'Syncing…' : status}</span>
      </div>
      ...
      {user ? (
        ...
        <form className="stack" onSubmit={handleSubmit}>
          <div className="muted small">
            Use the same email on multiple devices to carry over your watchlist, selected asset, mode, strategy, timeframe, and onboarding state.
          </div>
          <input
            className="input"
            type="email"
