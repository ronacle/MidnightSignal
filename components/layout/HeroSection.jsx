      ...
      <div className="stack hero-copy premium-hero-copy">
        <div className="brand-row brand-row-large premium-brand-row">
          ...
          <div className="brand-copy">
            <div className="eyebrow eyebrow-glow">Midnight Signal · v11.81.3</div>
        ...
        <div className="hero-mobile-hint muted small">Mobile flow: start with Tonight’s Top Signal, tap any asset card for details, then use Controls for session changes.</div>
        <div className="hero-conversion-row premium-conversion-row">
          <div className="hero-conversion-card premium-callout-card"><div className="eyebrow">Start here</div><div className="hero-conversion-title">{experience.heroCtaTitle}</div><p className="muted small">{experience.heroCtaBody}</p><div className="row"><button className="button" onClick={onOpenControls} type="button">Open control panel</button><span className="badge">{setupLabel}</span></div></div>
