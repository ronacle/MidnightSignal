...
const GLOSSARY = [
  ...
  { term: 'Tonight’s Brief', beginner: 'A plain-English explanation of why the top signal is leading right now.', pro: 'Narrative summary of current signal leadership.' },
