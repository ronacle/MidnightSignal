...
<section class="${showAlertsTab ? '' : 'tab-panel-hidden'}">
  <div class="placeholder-card">
    ...
    <div class="subtitle" style="margin-top:8px">This tab is now wired into the layout cleanly. Next builds can safely add alert history, X-driven signal context, or watchlist notifications here without disturbing the core Signals view.</div>
  </div>
</section>
