    ...
    <main className="page">
      <div className="shell">
          ...
          <div className="stack hero-copy">
            <div className="brand-row brand-row-large">
              ...
              <div className="brand-copy">
                <div className="eyebrow">Midnight Signal · v11.10.4</div>
            ...
            <div className="hero-pill-row">
              ...
              <span className="badge">Preferred UI + panels</span>
        ...
        <div className="footer-note">
          Build v11.10.4 · full shell restore + sync merge · menu, controls, learning panel restored
        </div>
      </div>
    </main>
  );
