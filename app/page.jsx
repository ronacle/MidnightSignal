    ...
    <main className="page">
      <div className="shell">
        ...
        <section className="hero hero-shell">
          <div className="stack hero-copy">
            <div className="brand-row brand-row-large">
              ...
              <div className="brand-copy">
                <div className="eyebrow">Midnight Signal · v11.10.2</div>
            ...
            <div className="hero-pill-row">
              <span className="badge glow-badge">Animated beacon restored</span>
              <span className="badge">Full shell restored</span>
              <span className="badge">Cross-device sync preserved</span>
            </div>

            <div className="notice small">
              The goal of this build is simple: keep the newer account sync foundation, but bring back the fuller Midnight Signal shell — menu, control settings, learning panel, and the branded top-of-page feel.
            </div>
          </div>
          ...
          <div className="hero-stat-grid">
            ...
            <div className="mini">
              ...
              <div className="muted small">Clear posture, separate from conviction</div>
            </div>
            <div className="mini">
              <div className="eyebrow">Conviction</div>
              <div className="value">{selected.conviction}%</div>
              <div className="muted small">How aligned the setup is right now</div>
            </div>
            <div className="mini">
        ...
        <div className="footer-note">
          Build v11.10.2 · full shell restore + sync merge · menu, controls, learning panel restored
        </div>
      </div>
    </main>
  );
