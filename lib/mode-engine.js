...
export function applyModePreset(state = {}, override = {}) {
  ...
  return { ...state, userType: base.userType, intent: base.intent, mode: base.recommended.mode, strategy: base.recommended.strategy, timeframe: base.recommended.timeframe, livePulseEnabled: base.recommended.livePulseEnabled, signalSoundsEnabled: base.recommended.signalSoundsEnabled, dashboardFocus: base.recommended.dashboardFocus, onboardingGoal: base.intent, onboardingCompletedAt: state.onboardingCompletedAt || new Date().toISOString(), modeEngineVersion: '11.82' };
}
