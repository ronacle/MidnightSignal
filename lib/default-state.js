export const DEFAULT_STATE = {
  ...
  soundProfile: 'beacon-soft',
  restoreLastSelectedAsset: true,
  restorePanelState: true,
  preferredDashboardFocus: 'top-signal',
  onboardingCompletedAt: null,
  onboardingUserType: 'Beginner',
  onboardingGoal: 'Learn',
  authLastEvent: '',
  authLastEventAt: null,
  alertDeliveryEnabled: false,
  alertDeliveryEmail: '',
  alertCooldownMinutes: '30',
  alertDigestMode: 'instant',
  alertDeliveryScope: 'watchlist',
  ...
  alertEmailDeliveryMemory: { sentLog: {}, recent: [] },
  entitlement: {
    status: 'inactive',
    verified: false,
    source: 'local',
