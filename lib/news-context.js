...
function buildCatalystBridge(feed = []) {
  ...
  return {
    source: 'Cardano Midnight News ready',
    detail: 'This feed now accepts catalystType, assetMentions, sentimentHint, and relevance scoring so article, RSS, and X workflows can slot into the same context model cleanly.',
    counts,
  };
}
