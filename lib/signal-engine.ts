...
function buildPayload(grid: SignalSnapshot[], source: "coingecko" | "fallback"): DashboardPayload {
  ...
  return {
    ...
    sinceLastVisit: [
      ...
      `Leadership is still narrow, which usually rewards focus over overtrading.`
    ],
    settings: {
      mode: "Beginner",
      strategy: "Swing",
...
function fallbackPayload(): DashboardPayload {
  const fallback: SignalSnapshot[] = [
    { asset: "BTC", symbol: "BTC", price: 67000, priceChange24h: 2.1, volume24h: 24000000000, marketCap: 1300000000000, label: "Bullish Momentum", confidence: 71, posture: "Fallback posture: positive bias remains intact.", breakdown: { trend: 70, momentum: 72, structure: 68 } },
    { asset: "ETH", symbol: "ETH", price: 3400, priceChange24h: 1.3, volume24h: 14000000000, marketCap: 420000000000, label: "Bullish Momentum", confidence: 66, posture: "Fallback posture: constructive but less forceful than BTC.", breakdown: { trend: 64, momentum: 67, structure: 66 } },
    { asset: "SOL", symbol: "SOL", price: 155, priceChange24h: -0.4, volume24h: 4000000000, marketCap: 70000000000, label: "Neutral Drift", confidence: 54, posture: "Fallback posture: mixed read.", breakdown: { trend: 54, momentum: 52, structure: 56 } },
    { asset: "ADA", symbol: "ADA", price: 0.68, priceChange24h: -1.8, volume24h: 600000000, marketCap: 24000000000, label: "Bearish Pressure", confidence: 42, posture: "Fallback posture: pressure remains elevated.", breakdown: { trend: 39, momentum: 42, structure: 45 } }
  ];
